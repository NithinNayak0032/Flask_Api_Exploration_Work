...
from resources.hospitals import HospitalRegister,ListHospital,ListGroup,HospitalDetail,HospitalGroupAgg,HospitalGroupMonthlyAgg
from db import db
from ma import ma
import datetime
import os
...
api.add_resource(HospitalGroupAgg,'/get_group_details');
api.add_resource(HospitalGroupMonthlyAgg,'/get_monthly_details/<string:group_name>')
